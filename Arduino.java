...
public class Arduino extends JFrame implements Runnable{
	...
	JLabel lbAutor = new JLabel("Autor: Denis Augusto Bopp da Silva - Ufrgs");
	...
	public Arduino() {
		...
		chartPanel.setPreferredSize(new Dimension(Width-(230), Height -(80)));
		...
		this.getContentPane().addComponentListener(new ComponentListener(){
			...
			public void componentResized(ComponentEvent e) {
				...
				chartPanel.setSize(new Dimension(new Dimension(getWidth()-230, getHeight()-80)));	
		...
		this.setTitle("Arduino Data Logger/Plotter - Denis Augusto Bopp da Silva - UFRGS");
